...
function Profile() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await axios.put(
        "https://blog-website-jueq.vercel.app/api/auth/profile",
        { name, email },
        {
          headers: {
  ...
  try {
    const res = await axios.get(
      "https://blog-website-jueq.vercel.app/api/auth/bookmarks",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
fetchBookmarks();
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      await axios.delete("https://blog-website-jueq.vercel.app/api/auth/profile", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
